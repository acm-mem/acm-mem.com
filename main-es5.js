...
/* harmony import */ var _ctrl_ngx_github_buttons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ctrl/ngx-github-buttons */ "./node_modules/@ctrl/ngx-github-buttons/fesm5/ctrl-ngx-github-buttons.js");
...
/* harmony import */ var ngx_window_token__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ngx-window-token */ "./node_modules/ngx-window-token/fesm5/ngx-window-token.js");
...
/* harmony import */ var ngx_progressive_image_loader__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ngx-progressive-image-loader */ "./node_modules/ngx-progressive-image-loader/fesm5/ngx-progressive-image-loader.js");
...
/* harmony import */ var ngx_loading__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ngx-loading */ "./node_modules/ngx-loading/fesm5/ngx-loading.js");
...
/* harmony import */ var _ctrl_ngx_github_buttons__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @ctrl/ngx-github-buttons */ "./node_modules/@ctrl/ngx-github-buttons/fesm5/ctrl-ngx-github-buttons.js");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
var Calendar = /** @class */ (function (_super) {
    ...
    Calendar_1 = Calendar;
    Calendar.fromJSON = function (data) {
        var newCalendar = new Calendar_1();
    ...
    return Calendar;
}(ts_serializer__WEBPACK_IMPORTED_MODULE_1__["Serializable"]));
...
var Entity = /** @class */ (function (_super) {
    ...
    return Entity;
}(ts_serializer__WEBPACK_IMPORTED_MODULE_2__["Serializable"]));
...
var EventGroup = /** @class */ (function () {
    function EventGroup(events, date) {
        this.events = events;
        this.date = date;
    }
    return EventGroup;
...
var Event = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Event.prototype, "createdDate", {
        get: function () {
            if (this.created) {
    ...
    Object.defineProperty(Event.prototype, "parsedStartDate", {
        get: function () {
            if (this.startDate) {
                // @ts-ignore
    ...
    Object.defineProperty(Event.prototype, "parsedEndDate", {
        get: function () {
            if (this.endDate) {
                // @ts-ignore
    ...
    Event.prototype.convertDate = function (dateString) {
        ...
        var hour = Number(dateString.substr(9, 2));
        var minute = Number(dateString.substr(11, 2));
        var second = Number(dateString.substr(13, 2));
        return new Date(Date.UTC(year, month, day, hour, minute, second));
    };
    Event.prototype.convertSingleDate = function (dateString) {
        var year = Number(dateString.substr(0, 4));
        var month = parseInt(dateString.substr(4, 2), 10) - 1;
        var day = Number(dateString.substr(6, 2));
        return new Date(Date.UTC(year, month, day));
    };
    Event.prototype.validateDate = function (dateString) {
        ...
        return d
            .filter(function (x, i) { return i !== T_INDEX && i !== Z_INDEX; })
            // tslint:disable-next-line:radix
            .every(function (x) { return !isNaN(parseInt(x)); });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(ts_serializer__WEBPACK_IMPORTED_MODULE_1__["SerializeProperty"])()
...
var MediaEntry = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](MediaEntry, _super);
    function MediaEntry() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var Tweet = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](Tweet, _super);
    function Tweet() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Tweet_1 = Tweet;
    Object.defineProperty(Tweet.prototype, "imageURL", {
        get: function () {
    ...
    Tweet.fromJSON = function (data) {
        var newTweet = new Tweet_1();
...
var EventDatePipe = /** @class */ (function () {
    function EventDatePipe() {
    }
    EventDatePipe.prototype.transform = function (event) {
        var transformedString = '';
        if (event.isAllDay) {
            var localeOptions = { weekday: 'long', year: 'numeric', month: 'numeric', day: 'numeric' };
            var localeStartDate = event.startDate.toLocaleDateString('en-US', localeOptions);
            var localeEndDate = event.endDate.toLocaleDateString('en-US', localeOptions);
...
var EventGroupDatePipe = /** @class */ (function () {
    function EventGroupDatePipe() {
    }
    EventGroupDatePipe.prototype.transform = function (date) {
        var localeOptions = { weekday: 'long', year: 'numeric', month: 'numeric', day: 'numeric' };
        return date.toLocaleDateString('en-US', localeOptions);
    };
    return EventGroupDatePipe;
}());
...
var TweetDate = /** @class */ (function () {
    function TweetDate() {
    }
    TweetDate.prototype.transform = function (value) {
...
var TweetTextPipe = /** @class */ (function () {
    function TweetTextPipe() {
    }
    TweetTextPipe.prototype.transform = function (value) {
        return value.replace(/(?:https?|ftp):\/\/[\n\S]+/g, '');
    };
    return TweetTextPipe;
}());
...
var BackendService = /** @class */ (function () {
    ...
    BackendService.prototype.getTweets = function () {
        return this.httpClient.get('https://proxy.acm-mem.com:6969/api/tweets').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
            if (res.success) {
    ...
    BackendService.prototype.getMembers = function () {
        return this.httpClient.get('https://proxy.acm-mem.com:6969/api/roster').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
            var members = [];
            if (res.success) {
                res.members.forEach(function (member) {
                    if (!members.find(function (existingMember) { return existingMember.fullName === member.firstName + ' ' + member.lastName; })) {
                        members.push(_models_member_model__WEBPACK_IMPORTED_MODULE_3__["Member"].fromJSON(member));
                    }
                    else {
                        var existing = members.find(function (existingMember) { return existingMember.fullName === member.firstName + ' ' + member.lastName; });
                        existing.position = existing.position + ', ' + member.position;
                    }
                });
            }
            return members.sort(function (a, b) { return a.fullName.localeCompare(b.fullName); });
        }));
    };
    BackendService.prototype.getEvents = function () {
        return this.httpClient.get('https://proxy.acm-mem.com:6969/api/calendar').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
            if (res.success) {
                var calendar_1 = _models_calendar_model__WEBPACK_IMPORTED_MODULE_2__["Calendar"].fromJSON(res.calendars[0]);
                if (calendar_1 && calendar_1.events) {
                    var eventGroups_1 = [];
                    calendar_1.events.map(function (event) { return event.startDate; })
                        .forEach(function (eventDate) {
                        var today = new Date();
                        eventDate.setHours(0, 0, 0, 0);
                        today.setHours(0, 0, 0, 0);
                        if (eventDate >= today) {
                            var eventsForDate = calendar_1.events.filter(function (event) { return event.startDate.toISOString() === eventDate.toISOString(); });
                            console.log(eventsForDate);
                            eventGroups_1.push(new _models_event_group_model__WEBPACK_IMPORTED_MODULE_4__["EventGroup"](eventsForDate, eventDate));
                        }
                    });
                    return eventGroups_1;
                }
            }
            return [];
        }));
    };
    BackendService.prototype.getPictures = function () {
        return this.httpClient.get('https://proxy.acm-mem.com:6969/api/pictures').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
            if (res.success) {
...
var EventsComponent = /** @class */ (function () {
    function EventsComponent(title, backendService) {
        this.title = title;
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(title, backendService) {
        this.title = title;
        this.backendService = backendService;
...
var MembersComponent = /** @class */ (function () {
    function MembersComponent(title, backendService) {
        this.title = title;
        this.backendService = backendService;
...
/* harmony import */ var ngx_progressive_image_loader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-progressive-image-loader */ "./node_modules/ngx-progressive-image-loader/fesm5/ngx-progressive-image-loader.js");
/* harmony import */ var ngx_window_token__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-window-token */ "./node_modules/ngx-window-token/fesm5/ngx-window-token.js");
...
var PicturesComponent = /** @class */ (function () {
    function PicturesComponent(title, backendService) {
        this.title = title;
        this.backendService = backendService;
    ...
    PicturesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.pictures = this.backendService.getPictures().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (pictures) {
            _this.picturesTotal.next(pictures.length);
            _this.picturesTotal.complete();
